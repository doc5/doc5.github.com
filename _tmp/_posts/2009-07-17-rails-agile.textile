...
wget http://happy.github.com/file/dot/screenrc -O ~/.screenrc

#安装autossh，避免ssh闲时等待过长自动断开连接
sudo apt-get install autossh
#下载rscreen脚本,调用autossh登录后直接运行screen
wget http://happy.github.com/file/bin/rscreen -O /usr/local/bin/rscreen
...
#其他机连接问题机(ip为191,用户名为happy)
ssh 192.168.1.191 -l happy
#输入密码
</pre>
